...
class CustomColorScheme extends ThemeExtension<CustomColorScheme> {
  ...
  const CustomColorScheme.light({
    ...
    this.dividerProfile = const Color.fromARGB(255, 235, 232, 232),
    this.underlineProfile = const Color.fromARGB(255, 115, 114, 114),
  });
  ...
  CustomColorScheme lerp(ThemeExtension<CustomColorScheme>? other, double t) {
    ...
    return CustomColorScheme(
        ...
        underlineProfile:
            Color.lerp(underlineProfile, other.underlineProfile, t));
  }
}
