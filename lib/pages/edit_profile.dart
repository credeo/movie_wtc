                            ...
                            child: Column(
                              children: [
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: Align(
                                        ...
                                        child: Image.asset('assets/icons/icon_profile_small.png'),
                                      ),
                                      enabledBorder: UnderlineInputBorder(
                                        borderSide: BorderSide(
                                          color: CustomColors.of(context).inactive.withOpacity(0.5),
                                          width: 1,
                                        ),
                                      ),
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: Align(
                                        alignment: Alignment.centerLeft,
                                        child: Image.asset('assets/icons/icon_eye_crossed.png'),
                                      ),
                                      enabledBorder: UnderlineInputBorder(
                                        borderSide: BorderSide(
                                          color: CustomColors.of(context).inactive.withOpacity(0.5),
                                ...
                                Padding(
                                  ...
                                  child: TextField(
                                    decoration: InputDecoration(
                                      hintText: 'edit_profile_confirm_pass'.tr(),
                                      hintStyle: CustomTextStyles.of(context).regular15,
                                      prefixIconConstraints: const BoxConstraints(maxWidth: 35),
                                      prefixIcon: Align(
                                        alignment: Alignment.centerLeft,
