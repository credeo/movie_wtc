                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                        ...
                        child:
                            Image.asset(movie.coverImage, fit: BoxFit.cover)),
                    Padding(
                      padding:
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomButtonWithIcon(
                            ...
                            onPressed: () {
                              if (downloadProvider.isMovieAdd(movie) == -1) {
                                downloadProvider.addMovieForDownloading(movie);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    duration: const Duration(seconds: 1),
                                    content: Text(
                                        'Add ${movie.details} "${movie.title}" for downloading.'),
                                  ),
                                );
                              } else {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    duration: const Duration(seconds: 1),
                                    content: Text(
                                        '${movie.details} "${movie.title}" is already in the list!'),
                                  ),
                                );
                              }
                            },
